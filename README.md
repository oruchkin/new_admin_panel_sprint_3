...
поэтому ждите пока эластик и по[README.md](README.md)стгрес поднимутся, то что он там сыпет в логи - это нормально



!ВНИМАНИЕ! 

нужно три .env файла в папках app, etl, infra,
там есть .env.example (тупо все скопировать в .env и положить рядом)
